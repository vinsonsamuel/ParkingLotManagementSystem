...
<html>
    ...
    <%
        ...
        boolean state = ParkingDAO.memberCheck(uname);
        if(state) {%>
        ...
        <%}%>
        <a href="4sec-confirmation.jsp"><button class="back">&#8249;</button></a>
